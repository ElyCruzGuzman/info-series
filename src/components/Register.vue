				...
				<div class="tab-pane active" id="sign_up">
					<form class="form-horizontal login-form">
						<div class="form-group relative">
							<input required v-model='email' class="form-control input-lg" id="register_email" placeholder="E-mail"  type="email">
						</div>
						<div class="form-group relative">
							<input required v-model='password' class="form-control input-lg" id="register_password" placeholder="Password" type="password">
						</div>
						
						<div class="form-group">
							<button @click= 'register' class="btn btn-success btn-lg btn-block" type="button">Sign Up</button>
						</div>
						<hr>
					</form>
				</div>
...
<style>
	...
	.login-container-wrapper {
	  ...
	  background-image:url('https://gallery.yopriceville.com/var/albums/Backgrounds/Yellow_and_Orange_Background.png?m=1445097813');
